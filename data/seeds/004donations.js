...
exports.seed = function(knex) {
	return knex('donations').then(function() {
		return knex('donations').insert([
			...
			{ id: 4, donated_by: 3, donated_for: 6, donated_at: date.toDateString() },
			{ id: 5, donated_by: 2, donated_for: 5, donated_at: date.toDateString() },
			{ id: 6, donated_by: 1, donated_for: 4, donated_at: date.toDateString() }
		]);
	});
};
